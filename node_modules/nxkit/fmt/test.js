...
var server_2 = 8092;
var server_3 = 8093;
var s_1 = new server_4.default.ServerIMPL({ port: server_1, printLog: true });
s_1.start(); // start server
var s_2 = new server_4.default.ServerIMPL({ port: server_2, printLog: true });
s_2.start(); // start server
var s_3 = new server_4.default.ServerIMPL({ port: server_3, printLog: true });
